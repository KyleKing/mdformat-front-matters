...
settings too, under 'plugin.front_matters'. That is the only way to canary a
plugin whose behavior is off by default::

    "options": {"plugin": {"front_matters": {"argument": true}}}

'extensions' names other mdformat plugins the repo's own docs build depends on
(e.g. 'mkdocs' for MkDocs admonitions), on top of the 'front_matters' this
